...
export class ProposalCreation extends ethereum.Event {
  get params(): ProposalCreation__Params {
    return new ProposalCreation__Params(this);
  }
}

export class ProposalCreation__Params {
  _event: ProposalCreation;

  constructor(event: ProposalCreation) {
    this._event = event;
  }
...
export class ProposalRetraction extends ethereum.Event {
  get params(): ProposalRetraction__Params {
    return new ProposalRetraction__Params(this);
  }
}

export class ProposalRetraction__Params {
  _event: ProposalRetraction;

  constructor(event: ProposalRetraction) {
    this._event = event;
  }
...
export class RevealStart extends ethereum.Event {
  get params(): RevealStart__Params {
    return new RevealStart__Params(this);
  }
}

export class RevealStart__Params {
  _event: RevealStart;

  constructor(event: RevealStart) {
    this._event = event;
  }
}
...
export class VoteResult extends ethereum.Event {
  get params(): VoteResult__Params {
    return new VoteResult__Params(this);
  }
}

export class VoteResult__Params {
  _event: VoteResult;

  constructor(event: VoteResult) {
    this._event = event;
  }
...
export class VoteReveal extends ethereum.Event {
  get params(): VoteReveal__Params {
    return new VoteReveal__Params(this);
  }
}

export class VoteReveal__Params {
  _event: VoteReveal;

  constructor(event: VoteReveal) {
    this._event = event;
  }
...
export class CurrencyGovernance extends ethereum.SmartContract {
  ...
  IDEMPOTENT_INFLATION_MULTIPLIER(): BigInt {
    let result = super.call(
      "IDEMPOTENT_INFLATION_MULTIPLIER",
      "IDEMPOTENT_INFLATION_MULTIPLIER():(uint256)",
      []
    );
  ...
  try_IDEMPOTENT_INFLATION_MULTIPLIER(): ethereum.CallResult<BigInt> {
  ...
  proposals(param0: Address): CurrencyGovernance__proposalsResult {
    let result = super.call(
      "proposals",
      "proposals(address):(uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    );
