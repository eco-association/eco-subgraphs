...
export class ECOxStaking__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class ECOxStaking extends ethereum.SmartContract {
  static bind(address: Address): ECOxStaking {
    return new ECOxStaking("ECOxStaking", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): ECOxStaking__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new ECOxStaking__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<ECOxStaking__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint256):(uint32,uint224)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new ECOxStaking__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
